...
void ShowMainMenue();
void ShowTransactionsMainMenue();
...
bool WithdrawClientByAccountNumber(string AccountNumber, vector <sClient>& vClients)
{
    ...
    if (FindClientByAccountNumber(AccountNumber, vClients, Client))
    {
        ...
        if (Answer == 'y' || Answer == 'Y')
        {
            ...
            cout << "\n\nDone Successfully. New Balance updated.\n";
            return true;
        }
...
void TotalBalancesAllClientsScreen()
{
    int Sum = 0;
    vector <sClient> vClients = LoadCleintsDataFromFile(ClientsFileName);
...
void PerfromTransactionsMainMenueOption(enTransactionsMainMenueOptions MainMenueOption)
{
    switch (MainMenueOption)
    {
    ...
    case enTransactionsMainMenueOptions::eTotalBalances:
    
        system("cls");
        TotalBalancesAllClientsScreen();
        GoBackToTransactionsMainMenue();
        break;
    
    case enTransactionsMainMenueOptions::eMainMenue:
        system("cls");
        ShowMainMenue();
        break;
    }
...
void ShowTransactionsMainMenue()
{
    ...
    cout << "\t[4] Main Menue.\n";
    cout << "===========================================\n";
    PerfromTransactionsMainMenueOption((enTransactionsMainMenueOptions)ReadTransactionsMenueOption());
}
